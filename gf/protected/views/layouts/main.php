        ...
        <div class="container">
          ...
          <ul class="nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="index.php?r=facturas">Facturas</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
<li><a href="index.php?r=impresiones/exportar&resumen=citiVentas">Exportar Afip</a></li>
                <li class="divider"></li>
          ...
          <ul class="nav secondary-nav">
            <li class="dropdown">
              <a href="#" class="dropdown-toggle">Sistema</a>
              <ul class="dropdown-menu">
                <li><a href="index.php?r=site/logout">Salir</a></li>
