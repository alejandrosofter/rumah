...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'idPreventaEmpresa'); ?>
		<?php echo $form->textField($model,'idPreventaEmpresa'); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'interes',array('size'=>60,'maxlength'=>255)); ?>
	</div>
