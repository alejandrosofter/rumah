...
class EventsUserpreference extends CActiveRecord
{
	...
	{
		return array(
			'user_id' => Yii::t('CalModule.EventsUserPreference', 'Usuario'),
			'mobile' => Yii::t('CalModule.EventsUserPreference', 'Celular'),
			'mobile_alert' => Yii::t('CalModule.EventsUserPreference', 'Alerta Celular'),
			'email' => Yii::t('CalModule.EventsUserPreference', 'Email'),
			'email_alert' => Yii::t('CalModule.EventsUserPreference', 'Alerta Email'),
		);
	}
