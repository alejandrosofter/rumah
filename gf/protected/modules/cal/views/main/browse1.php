...
<div class="form">
    ...
    <div class="row">
        <?php
        echo CHtml::label(Yii::t('CalModule.fullCal', 'Cominezo'), "EventCal_start");
...
<?php $this->endWidget('zii.widgets.jui.CJuiDialog'); ?>
    ...
    <?php
        echo '&laquo;';
        echo CHtml::link(Yii::t('CalModule.fullCal', 'Lista de eventos'), '#',
                array('onclick' => "$('#dlg_eventsHelper').dialog('open');"));
        echo '&raquo; ';
        if($calendarOptions['cronPeriod'])
        {
            echo '&laquo;';
            echo CHtml::link(Yii::t('CalModule.EventsUserPreference', 'Preferencias'), '#',
...
<?php
        $this->beginWidget('zii.widgets.jui.CJuiDialog', array(
            'id' => 'dlg_eventsHelper',
            'options' => array(
                'title' => Yii::t('CalModule.fullCal', 'Lista de Eventos'),
                'modal' => false,
                ...
                'buttons' => array(
                    ...
                    array(
                        'text' => Yii::t('CalModule.fullCal', 'Nuevo Evento'),
