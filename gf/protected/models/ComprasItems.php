...
//			 Please remove those attributes that should not be searched.
	...
	public function getStockFactura($idFactura)
	{
		$criteria=new CDbCriteria;

		$criteria->compare('idFacturaEntrante',$idFactura);
		
		$criteria->select = "t.*,stock.nombre as nombre,t.cantidad as cantidadDisponible, (t.importeCompra*t.cantidad) as importeTotal,stock.codigoBarra, stock.nombre as nombreStock, porcentajeIva, porcentajeGananciaLista,porcentajeGananciaMin,+ "
