	...
	public  function afterSave()
	{
		...
		$factVencimiento=FacturasSalientesVencimiento::model()->consultarFacturaUnica($this->idFacturaSaliente);
                if($factVencimiento!=false){
                        $resto=round($factVencimiento['importeFacturaSaliente'],Settings::model()->getValorSistema('DECIMALES_FACTURAS'))-round($factVencimiento['pagado'],Settings::model()->getValorSistema('DECIMALES_FACTURAS'));
