...
if ($_POST && $_POST['i']=='2')
{
	...
	else
	{
		...
		$str="<?php \n";
		$str.="define('C_HOST','".$_POST['C_HOST']."'); \n";
		$str.="define('C_USER','".$_POST['C_USER']."'); \n";
		$str.="define('C_PASS','".$_POST['C_PASS']."'); \n";
		$str.="define('C_BASE','".$_POST['C_DATA']."'); \n";
		$str.="define('C_FOLDER','".$_POST['C_FOLDER']."'); \n\n";

		$str.="mysql_connect(C_HOST, C_USER, C_PASS) \n";
		$str.="or die(\"ERROR: Cannot Connect To Database.\"); \n\n";
 
		$str.="mysql_select_db(C_BASE) \n";
		$str.="or die(\"ERROR: Cannot connect to Database.\"); \n";
...
<div style="padding-top:10px;width:100%;text-align:center;font-family: Arial, Verdana;font-size: 14px;">
...
<?php if (!$_POST){?>
	...
	<td align=center>
		...
		<br>
		<br>
		To begin the installation, please confirm you have read and agree to the <a href="http://prochatrooms.com/software_licence.php" target="_blank">software licence</a>.
		<br>
		<br>
...
<?php if ($_POST && $_POST['i']=='1'){?>
	...
	<tr><td align=center>
		...
		<table cellpadding="10" width="500" style="border: 1px solid #84B2DE;background-color: #FFFFFF;font-family: Arial, Verdana;font-size: 12px;font-style: normal;">
		<tr><td align=center width="60">
		<img src="images/help.gif" align="absmiddle">
		</td><td>
		<br>
		...
		<?php if($mysql_check == 'fail'){?>
				<tr><td colspan="2" style="color: red;">Error: Could not connect to MySQL database</td></tr>
				<tr><td>&nbsp;</td></tr>
		<?php }?>
		...
		<tr><td>&nbsp;</td></tr>
		<tr><td>Chat Room Folder*</td><td><input type="text" name="C_FOLDER" value=""></td></tr>
		<tr><td>&nbsp;</td><td>*if chat room is root folder, leave blank</td></tr>
		<tr><td>&nbsp;</td></tr>
...
<?php if ($_POST && $_POST['i']=='3'){?>
	...
	*/
	...
	$sql = "DROP TABLE IF EXISTS `prochatrooms_config`";mysql_query($sql);
	$sql = "DROP TABLE IF EXISTS `prochatrooms_group`";mysql_query($sql);
	$sql = "DROP TABLE IF EXISTS `prochatrooms_message`";mysql_query($sql);
	$sql = "DROP TABLE IF EXISTS `prochatrooms_profiles`";mysql_query($sql);
	$sql = "DROP TABLE IF EXISTS `prochatrooms_rooms`";mysql_query($sql);
	$sql = "DROP TABLE IF EXISTS `prochatrooms_users`";mysql_query($sql);
	...
	*/
	...
	$sql = "CREATE TABLE IF NOT EXISTS `prochatrooms_config` (
	...
	if(mysql_query($sql)) echo "&#187; prochatrooms_config - <font color=\"#33FF00\"><b>INSTALLED</b></font>";
	else echo "&#187; prochatrooms_config - <font color=\"#FF0000\"><b>FAIL</b></font>";
	...
	*/
	...
	$sql = "CREATE TABLE IF NOT EXISTS `prochatrooms_group` (
  	`id` varchar(3) NOT NULL DEFAULT '1',
  	`groupName` varchar(64) NOT NULL DEFAULT '',
  	`groupChat` varchar(3) NOT NULL DEFAULT '',
  	`groupPChat` varchar(3) NOT NULL DEFAULT '',
  	`groupCams` varchar(3) NOT NULL DEFAULT '',
  	`groupWatch` varchar(3) NOT NULL DEFAULT '',
  	`groupRooms` varchar(3) NOT NULL DEFAULT '',
  	UNIQUE KEY `id` (`id`)
	) ENGINE=MyISAM DEFAULT CHARSET=latin1";

	if(mysql_query($sql)) echo "&#187; prochatrooms_groups - <font color=\"#33FF00\"><b>INSTALLED</b></font>";
	else echo "&#187; prochatrooms_groups - <font color=\"#FF0000\"><b>FAIL</b></font>";
	...
	*/
	...
	$sql = "INSERT INTO `prochatrooms_group` (`id`, `groupName`, `groupChat`, `groupPChat`, `groupCams`, `groupWatch`, `groupRooms`) VALUES ('2', 'Member', '1', '1', '1', '1', '1'),('1', 'Guest', '1', '1', '0', '0', '0')";

	if(mysql_query($sql)) echo "&#43; groups settings - <font color=\"#33FF00\"><b>INSTALLED</b></font>";
	else echo "&#43; groups settings - <font color=\"#FF0000\"><b>FAIL</b></font>";
	...
	*/
	...
	$sql = "CREATE TABLE IF NOT EXISTS `prochatrooms_message` (
  	`id` int(11) NOT NULL AUTO_INCREMENT,
	...
	if(mysql_query($sql)) echo "&#187; prochatrooms_message - <font color=\"#33FF00\"><b>INSTALLED</b></font>";
	else echo "&#187; prochatrooms_message - <font color=\"#FF0000\"><b>FAIL</b></font>";
	...
	*/
	...
	$sql = "CREATE TABLE IF NOT EXISTS `prochatrooms_profiles` (
  	`id` int(11) NOT NULL AUTO_INCREMENT,
	...
	if(mysql_query($sql)) echo "&#187; prochatrooms_profiles - <font color=\"#33FF00\"><b>INSTALLED</b></font>";
	else echo "&#187; prochatrooms_profiles - <font color=\"#FF0000\"><b>FAIL</b></font>";
	...
	*/
	...
	$sql = "CREATE TABLE IF NOT EXISTS `prochatrooms_rooms` (
	...
	if(mysql_query($sql)) echo "&#187; prochatrooms_rooms - <font color=\"#33FF00\"><b>INSTALLED</b></font>";
	else echo "&#187; prochatrooms_rooms - <font color=\"#FF0000\"><b>FAIL</b></font>";
	...
	*/
	...
	$sql = "INSERT INTO `prochatrooms_rooms` (`id`, `roomid`, `roomname`, `roomowner`, `roompassword`, `roomusers`, `roomcreated`, `roombg`, `roomdesc`) VALUES
	...
	if(mysql_query($sql)) echo "&#43; rooms settings - <font color=\"#33FF00\"><b>INSTALLED</b></font>";
	else echo "&#43; rooms settings - <font color=\"#FF0000\"><b>FAIL</b></font>";
	...
	*/
	...
	$sql = "CREATE TABLE IF NOT EXISTS `prochatrooms_users` (
  	`id` int(11) NOT NULL AUTO_INCREMENT,
  	`username` varchar(255) NOT NULL DEFAULT '',
	...
	if(mysql_query($sql)) echo "&#187; prochatrooms_users - <font color=\"#33FF00\"><b>INSTALLED</b></font>";
	else echo "&#187; prochatrooms_users - <font color=\"#FF0000\"><b>FAIL</b></font>";
	...
	<tr><td>
	If all tables have successfully installed, please delete the folder '<b>install</b>' and CHMOD the file 'includes/db.php' to 644. 
	</td></tr>
	<tr><td>&nbsp;</td></tr>
	...
	<tr><td>Login to the <a href="../admin/" target="_blank">admin area</a>.</td></tr>
	<tr><td>&nbsp;</td></tr>
...
<br>
<div style="width:100%;text-align:center;font-family: Arial, Verdana;font-size: 12px;font-style: normal;">
	If you require support during the installation process, please <a href="http://www.prochatrooms.com/contact.php" target="_blank">contact us</a>.
	<br>
	&copy;<?php echo date("Y");?> <a href="http://www.prochatrooms.com/" target="_blank">Pro Chat Rooms</a> All Rights Reserved.
<div>
