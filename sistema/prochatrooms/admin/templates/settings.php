...
<form action ="index.php?option=settings" method="post" name="settings">
	...
	<table>
	<tr class="header"><td colspan="3">:: Settings</td></tr>
	<tr class="header"><td colspan="3">&nbsp;</td></tr>
	<tr class="header"><td>Option</td><td>Settings</td><td>Information</td></tr>
	<tr><td width="100">login password</td><td><input type="text" name="adminLogin" value=""></td><td>Password to login to admin area.<br>Leave blank if no change.<br><br></td></tr>
	<tr><td>avatars</td><td width="300"><textarea name="avatars"><?php echo $avatars;?></textarea></td><td>Seperate all values with a comma,<br>Example: <i>image1.gif, image2.gif, image3.gif</i><br><br>Upload all images to <i>/avatars/</i> folder.</td></tr>
	<tr><td>badwords</td><td><textarea name="badwords"><?php echo $badwords;?></textarea></td><td>Seperate all values with a comma,<br>Example: <i>word1, word2, word3</i></td></tr>
	<tr><td>font_color</td><td><textarea name="font_color"><?php echo $font_color;?></textarea></td><td>Seperate all values with a comma,<br>Example: <i>#000000, #F5F5F5, #FFFFFF</i></td></tr>
	<tr><td>font_size</td><td><textarea name="font_size"><?php echo $font_size;?></textarea></td><td>Seperate all values with a comma,<br>Example: <i>10px, 12px, 14px</i></td></tr>
	<tr><td>font_family</td><td><textarea name="font_family"><?php echo $font_family;?></textarea></td><td>Seperate all values with a comma,<br>Example: <i>Arial, Verdana, Courier</i></td></tr>
	<tr><td>sfx</td><td><textarea name="sfx"><?php echo $sfx;?></textarea></td><td>Seperate all values with a comma,<br>Example: <i>sfx1.mp3, sfx2.mp3, sfx3.mp3</i><br><br>Upload all mp3 to <i>/sounds/sfx/</i> folder.</td></tr>
	...
	<tr><td>refreshRate</td><td><input type="text" name="refreshRate" value="<?php echo $refreshRate;?>"></td><td>Milliseconds</td></tr>
	...
	<tr><td>admin</td><td><textarea name="admin"><?php echo $admin;?></textarea></td><td>Seperate all values with a comma,<br>Example: <i>user1, user2, user3</i></td></tr>
	<tr><td>moderator</td><td><textarea name="moderator"><?php echo $moderator;?></textarea></td><td>Seperate all values with a comma,<br>Example: <i>user1, user2, user3</i></td></tr>
	<tr><td>speaker</td><td><textarea name="speaker"><?php echo $speaker;?></textarea></td><td>Seperate all values with a comma,<br>Example: <i>user1, user2, user3</i></td></tr>
	...
	<tr><td>news</td><td><textarea name="news"><?php echo $news;?></textarea></td><td>This is displayed on login page</td></tr>
	<tr><td>&nbsp;</td><td colspan="2"><input type="submit" name="update" value="Update Settings"></td></tr>
	</table>
