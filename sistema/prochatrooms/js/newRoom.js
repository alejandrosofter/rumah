...
function addRoom()
{
	...
	{
		showInfoBox("system","200","300","200","",lang28);
	...
	for (i=0; i < checkRoomName.length; i++)
	{
		if(badChars.indexOf("|"+checkRoomName[i]+"|") != '-1')
		{
			...
			showInfoBox("system","200","300","200","","Room name contains illegal characters [ "+checkRoomName[i]+" ]");
	...
	if (updateUserRooms.readyState == 4 || updateUserRooms.readyState == 0)
	{
		...
		// visual confirm
		showInfoBox("system","200","300","200","",lang29);
