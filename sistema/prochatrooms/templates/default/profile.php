...
<?php }?>
	...
	<tr><td colspan="2" class="profileTableHeader">:: <?php echo C_LANG141;?></td></tr>
	<tr><td><?php echo C_LANG54;?>:</td><td>

		<?php echo urldecode($username);?> 

		<?php if(!$_REQUEST['edit'] && $_SESSION['myProfileID'] == $_REQUEST['id']){?>
			&nbsp;<span class="linka">[<a href="index.php?id=<?php echo $_REQUEST['id'];?>&edit=1"><?php echo C_LANG142;?></a>]</span>
		<?php }?>
	...
	<tr><td valign="top"><?php echo C_LANG150;?>:</td><td valign="top">
		...
		<?php }else{?>
			<pre><?php echo chunk_split(htmlspecialchars(stripslashes(urldecode($aboutme))),32,'&#8203;');?></pre>
		<?php }?>
	...
	<tr><td colspan="2" align="center" style="word-wrap: break-word;">&nbsp;
		...
		<?php if(isset($_REQUEST['edit'])){?>
			<input type="submit" name="submit" value="<?php echo C_LANG151;?>"><br><br>
