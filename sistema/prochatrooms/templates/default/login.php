...
<?php if($loginError){?>
	<div class="welcomeMessage"><?php echo $loginError;?></div>
<?php }?>
...
<div id="loginContainer" class="loginContainer">
	...
	<div id="loginLeft" class="loginLeft">
		...
		<tr><td>&nbsp;</td><td><input class="loginSubmit" type="submit" name="newLogin" value="<?php echo C_LANG122;?>"></td></tr>
		...
		<tr><td>&nbsp;</td><td><input class="loginSubmit" type="submit" name="newRegister" value="<?php echo C_LANG124;?>"></td></tr>
		</table>
		</form>
