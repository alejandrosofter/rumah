...
<div class="cometchat_tabcontenttext" id="cometchat_tabcontenttext" style="width:100%;height:100%"><div class="welcomemessage">Logueate para cambiar el Theme</div></div>
...
<div class="cometchat_tabcontenttext" id="cometchat_tabcontenttext" style="width:100%;height:100%"><div class="welcomemessage">Theme Actual: <b>$currenttheme</b><br/><br/>

<b>Seleciona Otro theme:</b><br/><br/>{$themeslist}</div></div>
