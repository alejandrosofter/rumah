...
class m111104_191458_facturasEntrantesView_cambia extends CDbMigration
{
	public function up()
	{
...
GROUP BY t.idFacturaEntrante ORDER BY t.idFacturaEntrante desc );";
	...
	{
		echo "m111104_191458_facturasEntrantesView_cambia does not support migration down.\n";
		return false;
	}
