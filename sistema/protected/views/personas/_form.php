...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary($model); ?>
		...
		<?php echo $form->textField($model,'tipoCliente',array('size'=>30,'maxlength'=>30,'TYPE'=>'hidden','VALUE'=>'Persona')); ?>
	...
	<div class="row">
		...
		<?php   echo CHtml::dropDownList('Personas[condicionIva]', $model->condicionIva, $model->getCondicionesIva(),
              array('empty' => '(Seleccione la condicion IVA)'));?>
