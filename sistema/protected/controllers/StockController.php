	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('patientCard','vaciarCarro','quitarProductoCarro','consultarCarro','agregarCarro','estadisticaProducto','index','view','centroStock','stockReal','etiquetas' ,'AplicarPreciosServicios', 'aplicarPreciosCompra','aplicarStockInventario','AplicarPreciosInventario','aplicarPreciosCategoria'),
				'users'=>array('@'),
			),
...
//                $importe=;
	...
	public function actionEstadisticaProducto($idStock)
	{
		$model=new Stock;

		$this->render('estadisiticaProducto',array('ventas'=>ItemsFacturaSaliente::model()->ventasStock($idStock),
