...
<?php $form=$this->beginWidget('CActiveForm'); ?>
	...
	<div class="actions">
		<?php echo CHtml::submitButton(Rights::t('core', 'Guardar'),array('class'=>'btn primary')); ?> | <?php echo CHtml::link(Rights::t('core', 'Cancelar',array('class'=>'btn')), Yii::app()->user->rightsReturnUrl); ?>
	</div>
