...
class Impresiones extends CActiveRecord
{
	...
	{
    	return array('citiVentas' => 'Citi Ventas(.txt)');
	}
...
//            return $salida;
        ...
        {
            $salida= "<applet code=javademo/Main.java archive='scripts/fiscalLicencia.jar' width='$tamAppletx' height='$tamApplety'>
      <param name='texto' value='".($texto)."'>
      <param name='copias' value='$copias'>
      <param name='puerto' value='$impresora'>
      <param name='serial' value=' 27-0163848-435'>
