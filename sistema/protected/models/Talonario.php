...
class Talonario extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idPuntoVenta, predeterminado,desdeNumero, hastaNumero, proximo, numeroSerie', 'numerical', 'integerOnly'=>true),
			array('descripcion,letraTalonario,codigoPuntoVenta, tipoTalonario', 'length', 'max'=>255),
                     //array('certificado', 'file', 'types'=>'crt'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('idTalonario,certificado,key,csr, idPuntoVenta, desdeNumero, hastaNumero, proximo, letraTalonario, tipoTalonario, numeroSerie', 'safe', 'on'=>'search'),
		);
	}
